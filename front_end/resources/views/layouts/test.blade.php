...
@section('extra-css-js')
    ...
    <div class="container" style="margin-top: 100px;">
                ...
                <div class="input-group d-block justify-content-center">
                    ...
                    <div class="custom-file d-flex justify-content-end align-items-center">
                        <a href="#" id="pratinjauButton"
                            ...
                            style="margin-right: 10px; width: 200px; height: 70px;" disabled>Pratinjau</a>
                        ...
                        <div>
                            <input type="file" class="custom-file-input" id="fileInput" aria-describedby="fileInputAddon"
        ...
        <div id="pdfPreview" style="overflow-y: auto; max-height: 500px;">
            ...
            if (cachedPDF) {
                ...
                loadingTask.promise.then(function(pdf) {
                    pdf.getPage(1).then(function(page) {
                        ...
                        const scale = pdfPreview.offsetWidth / viewport
                        .width; // Calculate the scale based on the width of the viewport
