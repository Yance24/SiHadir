                        ...
                        <div id="content" class="content">
                            ...
                            <div class="col-sm-11 p-5 flex justify-content-center justify-content-lg-start mb-5"
                                ...
                                <div class="d-flex justify-content-center">
                                    <a href="{{ route('pemindai') }}" id="absenButton"
                                        class="btn btn-primary shadow-lg rounded-3 d-flex justify-content-center align-items-center"
                                        style="width: 200px; height: 50px">Absen</a>
                                </div>
                            </div>
                            <!-- END -->
